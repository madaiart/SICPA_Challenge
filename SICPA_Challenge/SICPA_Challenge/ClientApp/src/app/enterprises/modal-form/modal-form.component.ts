...
export class ModalFormComponentEnterprises implements OnInit {
  ...
  patch(id: string, formdata: any): void {
    this.apiHttpService
      .patch(this.apiEndpointsService.patchEnterprise(id), formdata)
      .subscribe(
        (resp: any) => {
  ...
  create(data: any): void {
    this.apiHttpService
      .post(this.apiEndpointsService.postEnterprise(), data)
      .subscribe(
        (resp: any) => {
          this.id = resp.data; //guid return in data
          this.result = {
